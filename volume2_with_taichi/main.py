...
def main_2():
    cam = camera(1, 1080, samples_per_pixel=5000, zoom=5, lookfrom=[278, 278, -800], lookat=[278, 278, 0], background_color=[0,0,0])
    world = list_hittable()
...
def main_4():
    ...
    cam = camera(16/9, 1920,samples_per_pixel=1000, lookfrom=[26,3,6], lookat=[0,2,0], zoom=7)
    world = list_hittable()
