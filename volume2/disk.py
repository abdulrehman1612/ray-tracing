...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 30 03:08:52 2025
...
class disk(hittable):
    def __init__(self, q1, u1, v1,r, material, q2 = None, u2 = None, v2 = None):
        ...
        self.r = r
        self.aabb = disk.enclose_quad(self.Q, self.u, self.v, (q2 == None and u2 == None and v2 == None))
    ...
    def hit(self, r: ray, ray_tmin: float, ray_tmax: float, rec: hit_record):
        ...
        if not (alpha*alpha + beta * beta)**0.5 < self.r:
            return False
